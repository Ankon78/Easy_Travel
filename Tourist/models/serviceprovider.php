...
return $con;
    ...
    function signup($serviceproviderno,$tourist,$PhoneNo,$CompanyName,$Place,$Duration){
		$con = getConnection();
		$sql = "insert into hotelbook values('{$serviceproviderno}', '{$tourist}', '{$PhoneNo}', '{$CompanyName}','{$Place}','{$Duration}')";
