...
<center><img src="../Photos/1.png"><br>
	<a class="font-effect-neon SBoyyy" style="color: #800080" href="touristlist.php"> Tourist list </a><br>
	<script src="../js/touristlist.js"></script>
...
<table border="1">
			<tr>
				<td class="SBoyyy"  style="font-size:12px;color:800080" >Tourist Number</td>
				<td class="SBoyyy"  style="font-size:12px;color:800080" >Tourist Name </td>
